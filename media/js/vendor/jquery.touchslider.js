...
(function($, undefined) {
	window.touchSlider = function(options) {
        ...
        var x_namespace = options.x_namespace || "";
		...
		options = $.extend({
				...
				delay: 3000,
				margin: 0,
				viewport: "." + namespace + "-viewport" + x_namespace,
				prev: "." + namespace + "-prev" + x_namespace,
				next: "." + namespace + "-next" + x_namespace,
				pagination: "." + namespace + "-nav-item" + x_namespace,
		...
		if (scroller.css("position") !== "absolute") {
            var slider_main_width = viewport.width();
//			var viewportHeight = slider_main_width/2;
        ...
        slides.css("width", slider_main_width);
        slides.css("height", viewportHeight);
        slides.find(".touch-slider-item-content").each(function()
        {
            var topp = (viewportHeight - $(this).outerHeight())/2;
            $(this).css("top",topp);
        });
//        hook_viewport = viewport;
//        hook_slides = slides;
...
//{
//    slider_main_width = hook_viewport.width();
//    hook_viewport.css("height",slider_main_width/2);
//    hook_slides.css("width",slider_main_width);
//    hook_slides.css("height",slider_main_width/2);
//});